...
public class Game extends Util {
    ...
    public boolean finalAct(Scanner input) {
        ...
        boolean mageResult = this.convertEvent(input, "hex", 1000, "Conversão correta! Você conjurou o feitiço final contra a criatura sombria!", "Você falhou em decifrar o código hexadecimal. A criatura sombria permanece invicta.");
        if (!mageResult) return false;
